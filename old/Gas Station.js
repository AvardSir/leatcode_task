...
var canCompleteCircuit = function(gas, cost) {
    ...
    // test_string=swap(test_string,last_ind)
    const test1=test_string.slice(last_ind)
    const test2=test_string.slice(0,last_ind)
    let test_string2=[...test1,...test2]
    [max_ind,last_ind]=max_subArray(ab)
    const max_subArray_delta=max_subArray(delta)
undefined
    let tank=0
